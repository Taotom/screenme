...
class Patient4Widget extends StatefulWidget {
  const Patient4Widget({Key key}) : super(key: key);

  @override
  _Patient4WidgetState createState() => _Patient4WidgetState();
}

class _Patient4WidgetState extends State<Patient4Widget> {
