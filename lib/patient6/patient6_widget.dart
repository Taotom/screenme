...
class Patient6Widget extends StatefulWidget {
  const Patient6Widget({Key key}) : super(key: key);

  @override
  _Patient6WidgetState createState() => _Patient6WidgetState();
}

class _Patient6WidgetState extends State<Patient6Widget> {
