...
class Patient2Widget extends StatefulWidget {
  const Patient2Widget({Key key}) : super(key: key);

  @override
  _Patient2WidgetState createState() => _Patient2WidgetState();
}

class _Patient2WidgetState extends State<Patient2Widget> {
